                ...
                <div class="panel panel-default">
                  ...
                  <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control total-price" name="" id="payAmount"  placeholder="Enter Amount" readonly>
                        </div>
...
var request_url="submitpayment.php";
    ...
    "currency": "INR",
    "name": "Rahul Collection", //your business name
    "description": data.userData.description,
    "image": "D:\New folder\2020_0203_15162000.jpg",
    ...
    "modal": {
    "ondismiss": function(){
         window.location.replace("http://localhost/public/payment-success.php?oid="+orderID);
     }
},
...
rzp1.on('payment.failed', function (response){
    ...
    window.location.replace("http://localhost/public/payment-failed.php?oid="+orderID+"&reason="+response.error.description+"&paymentid="+response.error.metadata.payment_id);
